package org.javaserverfaces.chapter06;
...
@SessionScoped
@Named(value="ch6AuthorController")
public class AuthorController implements Serializable {
    ...
    private void populateAuthors(){
        ...
        book1.setDescription("This is where the book description goes.");
        // Chapters used for Recipe 5-10
        book1 = addChapters1(book1);
        
        
        Book book2 = new Book("Java EE 7 Recipes", "javaee7recipes.png");
        book2.setDescription("This is where the book description goes.");
        book2 = addChapters2(book2);
        Book book3 = new Book("Java FX 2.0: Introduction By Example", "javafx.png");
        book3.setDescription("This is where the book description goes.");
    ...
    public void findAuthor(){
        if (this.authorLast != null){
            for(Author author:authorList){
                if(author.getLast().equalsIgnoreCase(authorLast)){
                    this.current = author;
                }
            }
        } else {
