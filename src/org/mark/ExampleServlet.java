...
public class ExampleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(result > 0){
                ...
                out.println("<br/><br/><a href='/ServletHelloWorld/ch02/inputForms.jspx'>Try Again</a>");
            }
    ...
    public int insertRow(String exampleNumber,
        ...
        String sql = "INSERT INTO JSP_EXAMPLE VALUES(" +
                     "?,?,?,?)";
        ...
        try {
            ...
            System.out.println("End create connection"); 
            /***** test ******/
